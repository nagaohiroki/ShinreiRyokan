...
VOID Fld_201::Set()
{
	...
	//ドアロック
	pDoorLock = NewObj(new Key201);
	pDoorLock->Ob()->objPos = D3DXVECTOR3(-4.86f,0.00f,-2.18f);
	//火
	 pFire = NewObj(new Fire);
	//オーディオ
...
VOID Fld_201::Update()
{
	...
	{	
		...
		if(pDoorBath->HitObjFlag(0))
		{
			...
			FldChange(new Fld_201_Bath, &D3DXVECTOR3(0.0f,0.35f,1.3f),-180.0f);
		}
	}
	//カメラ
